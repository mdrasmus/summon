...
\begin{tabular}{ll}
    ...
    Ctrl + up                  & zoom in \\
    Ctrl + down                & zoom out \\
    Shift + up                 & zoom in (y-axis only) \\
    Shift + down               & zoom out (y-axis only) \\
    Shift + right              & zoom in (x-axis only) \\
    Shift + left               & zoom out (x-axis only) \\
    ...
    q                          & close window \\
    \`\  + left click          & display pop-up menu (note: {\em back-tic} is
                                 usually above {\em tab} key) \\
\end{tabular}
\vspace{.2in}
